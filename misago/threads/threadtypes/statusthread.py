...
class StatusThread(ThreadType):
    root_name = STATUS_THREADS_ROOT_NAME

    def get_category_name(self, category):
        return _('Status threads')

    def get_category_absolute_url(self, category):
        return reverse('misago:status-threads')

    def get_category_last_thread_url(self, category):
        return reverse(
            'misago:status-thread',
            kwargs={
    ...
    def get_thread_last_post_url(self, thread):
        return reverse(
            'misago:status-thread-last', kwargs={
                'slug': thread.slug,
                'pk': thread.pk,
            }
        )
    ...
    def get_thread_new_post_url(self, thread):
        return reverse(
            'misago:status-thread-new', kwargs={
                'slug': thread.slug,
                'pk': thread.pk,
            }
        )
    ...
    def get_thread_api_url(self, thread):
        return reverse(
            'misago:api:status-thread-detail', kwargs={
                'pk': thread.pk,
            }
        )
    ...
    def get_thread_editor_api_url(self, thread):
        return reverse(
            'misago:api:status-thread-post-editor', kwargs={
                'thread_pk': thread.pk,
            }
        )
    ...
    def get_thread_posts_api_url(self, thread):
        return reverse(
            'misago:api:status-thread-post-list', kwargs={
                'thread_pk': thread.pk,
            }
        )
    ...
    def get_post_merge_api_url(self, thread):
        return reverse(
            'misago:api:status-thread-post-merge', kwargs={
                'thread_pk': thread.pk,
            }
        )
    ...
    def get_post_api_url(self, post):
        return reverse(
            'misago:api:status-thread-post-detail',
            kwargs={
    ...
    def get_post_likes_api_url(self, post):
        return reverse(
            'misago:api:status-thread-post-likes',
            kwargs={
                'thread_pk': post.thread_id,
                'pk': post.pk,
            }
    ...
    def get_post_editor_api_url(self, post):
        return reverse(
            'misago:api:status-thread-post-editor',
            kwargs={
                'thread_pk': post.thread_id,
                'pk': post.pk,
            }
    ...
    def get_post_edits_api_url(self, post):
        return reverse(
            'misago:api:status-thread-post-edits',
            kwargs={
                'thread_pk': post.thread_id,
                'pk': post.pk,
            }
    ...
    def get_post_read_api_url(self, post):
        return reverse(
            'misago:api:status-thread-post-read',
            kwargs={
                'thread_pk': post.thread_id,
                'pk': post.pk,
            }
